...
Their feedback has been vital to ensure that our needles continue to set the highest standards in quality.  We believe passionately that artist feedback must always be at the heart of everything we do.
    ...
    <div id="main3">
        <div id="main3txtbox">
            ...
            <img class="eos" width="100%" src="https://dev.revolutionneedles.com/themes/classic/assets/img/eos.jpg">
            <img class="eosm" width="100%" src="https://dev.revolutionneedles.com/themes/classic/assets/img/eosm.jpg">
        </div>
    </div>
    <div id="main4">
        <h1 id="main4tit">
...
<div id="tattoosection">
    <div id="tatuagens">
        <div id="tattxt">
            ...
            <p class=tattootext>Mention <span class="hashtag">@RevolutionNeedles</span> and get a chance to be
                featured.</p>
        </div>
...
<div id="formsection">
    <div id="form">
        <div id="formDiv">
            ...
            <p id="formDescr">Join our private list and get our latest product releases and exclusive
                discounts.</p>
            <form method="post" enctype="multipart/form-data"
                ...
                <br>
                <input id="email" type="email" name="email_817" id="email_817" value="" autocomplete="off"
                       autocomplete="off" easyvalidation="true" placeholder="Enter your email" required>
                <br>
