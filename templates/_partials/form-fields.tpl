...
{else}
  ...
  <div class="form-group {if !empty($field.errors)}has-error{/if}">
    <label style="float:none" class="form-control-label loginName{if $field.required} required{/if}">
      {if $field.type !== 'checkbox'}
        {$field.label}
      {/if}
    </label>
    <div style="float:none" class="col-md-69{if ($field.type === 'radio-buttons')} form-control-valign{/if}">
